...
func setDefaults(v *viper.Viper, c Config) {
	...
	v.SetDefault("opencode.server_url", c.OpenCode.ServerURL)
	v.SetDefault("opencode.server_password", c.OpenCode.ServerPassword)
	v.SetDefault("opencode.serve_host", c.OpenCode.ServeHost)
	v.SetDefault("opencode.serve_port", c.OpenCode.ServePort)
	v.SetDefault("opencode.auto_start_server", c.OpenCode.AutoStartServer)
	v.SetDefault("opencode.startup_timeout", c.OpenCode.StartupTimeout)
